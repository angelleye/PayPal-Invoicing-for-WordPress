...
class AngellEYE_Invoice extends Invoice {
    ...
    public function recordPayment($paymentDetail, $apiContext = null, $restCall = null) {
        ...
        self::executeCall(
                "/v2/invoicing/invoices/{$this->getId()}/payments", "POST", $payLoad, null, $apiContext, $restCall
        );
        return true;
    }
    ...
    public function recordRefund($refundDetail, $apiContext = null, $restCall = null) {
        ...
        self::executeCall(
                "/v1/invoicing/invoices/{$this->getId()}/refunds", "POST", $payLoad, null, $apiContext, $restCall
        );
        return true;
    }
