            ...
            <div class="col-sm-12">
                <form method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="apifw_sandbox_paypal_email" placeholder="<?php echo __('Sandbox PayPal Email', 'angelleye-paypal-invoicing'); ?>" name="sandbox_paypal_email" value="<?php echo $sandbox_paypal_email; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="apifw_sandbox_client_id" placeholder="<?php echo __('Sandbox Client ID', 'angelleye-paypal-invoicing'); ?>" name="sandbox_client_id" value="<?php echo $sandbox_client_id; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="apifw_sandbox_secret" class="col-sm-2 col-form-label"><?php echo __('Sandbox Secret', 'angelleye-paypal-invoicing'); ?></label>
                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="apifw_sandbox_secret" placeholder="<?php echo __('Sandbox Secret', 'angelleye-paypal-invoicing'); ?>" name="sandbox_secret" value="<?php echo $sandbox_secret; ?>">
                        </div>
                    </div>
                    <!-- Live -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="apifw_paypal_email" placeholder="<?php echo __('PayPal Email', 'angelleye-paypal-invoicing'); ?>" name="paypal_email" value="<?php echo $paypal_email; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="apifw_client_id" class="col-sm-2 col-form-label"><?php echo __('Client ID', 'angelleye-paypal-invoicing'); ?></label>
                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="apifw_client_id" placeholder="<?php echo __('Client ID', 'angelleye-paypal-invoicing'); ?>" name="client_id" value="<?php echo $client_id; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="apifw_first_name" placeholder="<?php echo __('First Name', 'angelleye-paypal-invoicing'); ?>" name="first_name" value="<?php echo $first_name; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="apifw_last_name" class="col-sm-2 col-form-label"><?php echo __('Last Name', 'angelleye-paypal-invoicing'); ?></label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="apifw_last_name" placeholder="<?php echo __('Last Name', 'angelleye-paypal-invoicing'); ?>" name="last_name" value="<?php echo $last_name; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="apifw_note_to_recipient" placeholder="<?php echo __('Note to Recipient', 'angelleye-paypal-invoicing'); ?>" name="note_to_recipient" value="<?php echo $note_to_recipient; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
