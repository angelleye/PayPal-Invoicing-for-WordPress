...
<div class="deactivation-Modal-paypal-invocing">
    <div class="deactivation-Modal-paypal-invocing-header">
        <div>
            <button class="deactivation-Modal-paypal-invocing-return deactivation-icon-chevron-left"><?php _e('Return', 'paypal-for-woocommerce'); ?></button>
            <h2><?php _e('PayPal Invoicing for WordPress feedback', 'paypal-for-woocommerce'); ?></h2>
        </div>
        <button class="deactivation-Modal-paypal-invocing-close deactivation-icon-close"><?php _e('Close', 'paypal-for-woocommerce'); ?></button>
    </div>
    ...
    <div class="deactivation-Modal-paypal-invocing-footer">
        <div>
            <a href="<?php echo esc_attr($deactivation_url); ?>" class="button button-primary deactivation-isDisabled" disabled id="mixpanel-send-deactivation-paypal-invocing"><?php _e('Send & Deactivate', 'paypal-for-woocommerce'); ?></a>
            <button class="deactivation-Modal-paypal-invocing-cancel"><?php _e('Cancel', 'paypal-for-woocommerce'); ?></button>
        </div>
